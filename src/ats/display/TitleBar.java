...
public class TitleBar {
    ...
    public TitleBar() {
        view = new HBox(20);
        view.setStyle("-fx-padding: 10; -fx-alignment: center-left; -fx-background-color: #2C3E50;");
        ...
        view.getChildren().addAll(imageView, title, spacer, user, closeButton);
    }
